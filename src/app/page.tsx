    ...
    <div className="pb-20">
      ...
      <section className="container mx-auto px-4 py-16 md:py-32 text-center relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="bg-primary hover:bg-primary/90 text-white glow-primary uppercase tracking-[0.2em] font-bold px-10 h-14 w-full sm:w-auto">
            View Fleet
          </Button>
          <Button size="lg" variant="outline" className="border-border uppercase tracking-[0.2em] font-bold px-10 h-14 w-full sm:w-auto">
            Our Mission
          </Button>
        </div>
        <div className="mt-16 md:mt-24 flex justify-center animate-bounce text-muted-foreground">
          <ArrowDown className="w-6 h-6" />
        </div>
      </section>

      {/* Trust Badges */}
      <section className="border-y border-border bg-card/30 backdrop-blur-sm py-12 mb-20">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 text-center">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <span className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold">All-India Coverage</span>
          </div>
          <div className="flex flex-col items-center gap-3">
            <Package className="text-accent w-6 h-6" />
            <span className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold">Maintenance Included</span>
          </div>
        </div>
      </section>
